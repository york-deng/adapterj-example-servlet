 ...
 */
public class SimpleListServlet1 extends AbstractServlet {
						 ...
						 HttpServletResponse httpResponse) throws ServletException, IOException 
	{
		...
		try {
			...
			view.addMeta("_csrf", "97d6e6a8-47b2-480f-8931-0e91ea74aa3d");
			view.addMeta("_csrf", "X-CSRF-TOKEN");
			...
			view.bindAll(View.SERVER_SIDE_BINDING); // HTML_BINDING or SCRIPT_BINDING
